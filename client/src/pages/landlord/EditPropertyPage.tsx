...
const EditPropertyPage: React.FC = () => {
  ...
  const { selectedProperty, fetchPropertyById, updateProperty } = usePropertyStore();
  ...
  useEffect(() => {
    if (selectedProperty) {
      ...
      setValue('price', selectedProperty.price);
      setValue('bedrooms', selectedProperty.bedrooms);
      setValue('bathrooms', selectedProperty.bathrooms);
      setValue('area', selectedProperty.area);
      setValue('address', selectedProperty.address);
      setValue('amenities', selectedProperty.amenities);
      setValue('images', selectedProperty.images);
    }
